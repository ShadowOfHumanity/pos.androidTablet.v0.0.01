...
public class ActivityPastizzeria extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pastizzeria);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ActivityPastizzeria.this, ActivityMain.class);
        ...
        FoodButton7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                InsideOrder insideOrder = InsideOrder.getInstance();
                insideOrder.addData("Imqaret", "1.20");
                updateTotal();
